...
- [ ] TXXX Manual verification of all user stories
...
# After models complete, work on services and endpoints
...
- Follow constitution: clean code, frontend-backend separation, simplicity first
